...
/**
 * Created by Enrique on 03/11/2017.
 */
...
public class TwoDScrollView extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        if (mEnableScaling) {
            ...
            //KayakLog.debug(TwoDScrollView.class.getSimpleName(), String.format(Locale.getDefault(), "Position (%.2f,%.2f) ScrollOffset (%d,%d) Scale %.2f",event.getX(), event.getY(), getScrollX(), getScrollY(), mScale));
