...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.ViewHolder>
{
    ...
    private ArrayList<SubCategory> _items;
    private IViewHolderClick _listener;
    private Bitmap _placeHolder;

    public SubCategoryAdapter(Context context, ArrayList<SubCategory> items, IViewHolderClick listener )
    {
        _context = context;
        _items = items;
        _listener = listener;
    ...
    {
        View view = LayoutInflater.from( _context ).inflate( R.layout.subcategory_layout, parent, false );
    ...
    {
        SubCategory curSubCategory = _items.get(position);
        holder.get_labelProduct().setText(curSubCategory.getName());
        holder.setIndex( position );


        //holder.getIconView().setImageBitmap( _placeHolder );
        holder.getIconView().setImageResource(curSubCategory.getResId());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public ViewHolder( View view, IViewHolderClick listener )
        {
            ...
            _iconView = (ImageView) view.findViewById( R.id.imgSubCategory );
            _labelProduct = (TextView) view.findViewById( R.id.lblSubCategory );
            _listener = listener;
        }
