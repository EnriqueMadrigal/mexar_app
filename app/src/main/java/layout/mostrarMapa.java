 ...
 */
public class mostrarMapa extends Fragment implements View.OnClickListener{
    ...
    private View _view;
    private final  String TAG = "mostrarMapa";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_mostrar_mapa, container, false);
        _view = inflater.inflate( R.layout.fragment_mostrar_mapa, container, false );

        ArrayList<View> allButtons;
        allButtons = ((RelativeLayout) _view.findViewById(R.id.allButtons)).getTouchables();
    ...
    public void onClick(View v) {
        ...
        int curId = v.getId();
        String name = getResources().getResourceName(curId);
