 ...
 * {@link products_search.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link products_search#newInstance} factory method to
 * create an instance of this fragment.
 */
public class products_search extends Fragment {
    ...
    private productos.OnFragmentInteractionListener mListener;
    ...
    public static products_search newInstance(String curSearch) {
        products_search fragment = new products_search();
        Bundle args = new Bundle();

        args.putString("Search", curSearch);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        curSearch = (String) getArguments().getString("Search");
        ...
        try {
            ...
            for (int i = 0; i < res.length(); i++) {
                ...
                if (name.toLowerCase().contains(curSearch) || desc.toLowerCase().contains(curSearch) || desc_completa.contains(curSearch)) {
